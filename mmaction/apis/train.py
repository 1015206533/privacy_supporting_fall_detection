...
def train_model(model,
    ...
    if validate:
        #logger.info('inside validate hook')
    ...
    if cfg.get('domain_loss_lambda', None) is not None:
        runner_kwargs['domain_loss_lambda'] = cfg.domain_loss_lambda
    if cfg.get('pseudo_label_target', None) is not None:
        runner_kwargs['pseudo_label_target'] = cfg.pseudo_label_target
    if cfg.get('bridge_label_target', None) is not None:
        runner_kwargs['bridge_label_target'] = cfg.bridge_label_target
    if cfg.get('loss_type_list', None) is not None:
        runner_kwargs['loss_type_list'] = cfg.loss_type_list
    if cfg.get('is_loss_adaptative', None) is not None:
        runner_kwargs['is_loss_adaptative'] = cfg.is_loss_adaptative
