...
class IDMResNet3d(nn.Module):
    ...
    def __init__(self,
        ...
        self.idm = IDM(channel=self.base_channels)
...
@BACKBONES.register_module()
class IDMResNet3dLayer(nn.Module):
    """ResNet 3d Layer.
    ...
    def __init__(self,
        ...
        super().__init__()
        self.arch_settings = IDMResNet3d.arch_settings
        assert depth in self.arch_settings

        self.make_res_layer = IDMResNet3d.make_res_layer
        self._inflate_conv_params = IDMResNet3d._inflate_conv_params
        self._inflate_bn_params = IDMResNet3d._inflate_bn_params
        self._inflate_weights = IDMResNet3d._inflate_weights
        self._init_weights = IDMResNet3d._init_weights
...
if mmdet_imported:
    MMDET_SHARED_HEADS.register_module()(IDMResNet3dLayer)
    MMDET_BACKBONES.register_module()(IDMResNet3d)
