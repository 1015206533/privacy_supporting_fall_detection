...
class UdaRawframeDataset(BaseDataset):
    ...
    def load_annotations(self):
        ...
        with open(self.ann_file, 'r') as fin:
            for line in fin:
                ...
                #logger.info(f'line_split test, {line}, {line_split}')
                ...
                if self.with_offset:
                    ...
                    idx += 1
                # idx for label[s]
                class_label = int(line_split[idx])
                idx += 1
                domain_label = int(line_split[idx])
                video_info['label'] = class_label
                video_info['domain_label'] = domain_label
