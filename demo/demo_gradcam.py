...
def build_inputs(model, video_path, use_frames=False):
    ...
    # prepare data
    if use_frames:
        filename_tmpl = cfg.data.test.get('filename_tmpl', 'img_{:04}.png')
...
def main():
    ...
    if args.out_filename is not None:
        ...
        print('frames_batches.shape', frames_batches.shape)
