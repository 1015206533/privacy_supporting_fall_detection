# common setting
work_dir = './work_dirs/x3d_ur_fall_uda/20221018_V25_uda_pseudo_0.1_99' 
...
# kinetics 700 数据集
# test 
#ann_file_train = 'data/kinetics_700/annotation/shuffle_train_unsim.txt.tmp'
#ann_file_val = 'data/kinetics_700/annotation/shuffle_test_unsim_depth.txt.tmp'
#ann_file_test = 'data/kinetics_700/annotation/shuffle_test_unsim_depth.txt.tmp'
...
model = dict(  # Config of the model
    type='Recognizer3DPseudoLabel',  # Type of the recognizer
...
optimizer = dict(
    ...
    lr=0.0001,  # Learning rate, see detail usages of the parameters in the documentation of PyTorch
